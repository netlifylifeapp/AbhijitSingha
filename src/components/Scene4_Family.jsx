    ...
    <section ref={ref} className="scene-section relative z-10 py-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 1 }} className="text-center mb-14">
          ...
          <h2 className="font-serif text-3xl md:text-5xl italic mb-5" style={{ color: 'rgba(235,225,205,0.88)' }}>emotional distance</h2>
          <p className="font-sans text-sm" style={{ color: 'rgba(190,170,130,0.75)' }}>same house. different worlds.</p>
        </motion.div>
